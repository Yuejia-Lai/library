<template><div><h2 id="mysql中的数据类型" tabindex="-1"><a class="header-anchor" href="#mysql中的数据类型" aria-hidden="true">#</a> MySQL中的数据类型</h2>
<table>
<thead>
<tr>
<th>类型</th>
...
<h3 id="类型介绍" tabindex="-1"><a class="header-anchor" href="#类型介绍" aria-hidden="true">#</a> 类型介绍</h3>
...
<h3 id="可选属性" tabindex="-1"><a class="header-anchor" href="#可选属性" aria-hidden="true">#</a> 可选属性</h3>
<p><strong>整数类型的可选属性有三个：</strong></p>
<h4 id="m" tabindex="-1"><a class="header-anchor" href="#m" aria-hidden="true">#</a> M</h4>
...
<h4 id="unsigned" tabindex="-1"><a class="header-anchor" href="#unsigned" aria-hidden="true">#</a> UNSIGNED</h4>
...
<h4 id="zerofill" tabindex="-1"><a class="header-anchor" href="#zerofill" aria-hidden="true">#</a> ZEROFILL</h4>
...
<h3 id="如何选择" tabindex="-1"><a class="header-anchor" href="#如何选择" aria-hidden="true">#</a> 如何选择</h3>
...
<h2 id="浮点类型" tabindex="-1"><a class="header-anchor" href="#浮点类型" aria-hidden="true">#</a> 浮点类型</h2>
<h3 id="类型介绍-1" tabindex="-1"><a class="header-anchor" href="#类型介绍-1" aria-hidden="true">#</a> 类型介绍</h3>
...
<p><img src="https://s2.loli.net/2022/09/14/6HOBKLwDRVrfEaT.png" alt="image-20211007173312237.png" loading="lazy"></p>
<ul>
<li>
...
<h3 id="数据精度说明" tabindex="-1"><a class="header-anchor" href="#数据精度说明" aria-hidden="true">#</a> 数据精度说明</h3>
...
<h3 id="精度误差说明" tabindex="-1"><a class="header-anchor" href="#精度误差说明" aria-hidden="true">#</a> 精度误差说明</h3>
...
<h2 id="定点数类型" tabindex="-1"><a class="header-anchor" href="#定点数类型" aria-hidden="true">#</a> 定点数类型</h2>
<h3 id="类型介绍-2" tabindex="-1"><a class="header-anchor" href="#类型介绍-2" aria-hidden="true">#</a> 类型介绍</h3>
<ul>
<li>
...
<h2 id="位类型-bit" tabindex="-1"><a class="header-anchor" href="#位类型-bit" aria-hidden="true">#</a> 位类型：BIT</h2>
...
<h2 id="日期与时间类型" tabindex="-1"><a class="header-anchor" href="#日期与时间类型" aria-hidden="true">#</a> 日期与时间类型</h2>
...
<h3 id="year类型" tabindex="-1"><a class="header-anchor" href="#year类型" aria-hidden="true">#</a> YEAR类型</h3>
...
<h3 id="date类型" tabindex="-1"><a class="header-anchor" href="#date类型" aria-hidden="true">#</a> DATE类型</h3>
...
<h3 id="time类型" tabindex="-1"><a class="header-anchor" href="#time类型" aria-hidden="true">#</a> TIME类型</h3>
...
（2）可以使用不带有冒号的字符串或者数字，格式为'<code v-pre>HHMMSS</code>'或者<code v-pre>HHMMSS</code>。如果插入一个不合法的字符串或者数字，MySQL在存储数据时，会将其自动转化为00:00:00进行存储。比如1210，MySQL会将最右边的两位解析成秒，表示00:12:10，而不是12:10:00。
（3）使用<code v-pre>CURRENT_TIME()</code>或者<code v-pre>NOW()</code>，会插入当前系统的时间</p>
<h3 id="datetime类型" tabindex="-1"><a class="header-anchor" href="#datetime类型" aria-hidden="true">#</a> DATETIME类型</h3>
...
<h3 id="timestamp类型" tabindex="-1"><a class="header-anchor" href="#timestamp类型" aria-hidden="true">#</a> TIMESTAMP类型</h3>
...
<h3 id="开发中经验" tabindex="-1"><a class="header-anchor" href="#开发中经验" aria-hidden="true">#</a> 开发中经验</h3>
...
<h2 id="文本字符串类型" tabindex="-1"><a class="header-anchor" href="#文本字符串类型" aria-hidden="true">#</a> 文本字符串类型</h2>
...
<p><img src="https://s2.loli.net/2022/09/14/rxYNBVtTaOldMSe.png" alt="image-20211012003508730.png" loading="lazy"></p>
<h3 id="char与varchar类型" tabindex="-1"><a class="header-anchor" href="#char与varchar类型" aria-hidden="true">#</a> CHAR与VARCHAR类型</h3>
...
<h3 id="text类型" tabindex="-1"><a class="header-anchor" href="#text类型" aria-hidden="true">#</a> TEXT类型</h3>
...
<p>在保存和查询数据时，并没有删除TEXT类型的数据尾部的空格</p>
...
<h2 id="enum类型" tabindex="-1"><a class="header-anchor" href="#enum类型" aria-hidden="true">#</a> ENUM类型</h2>
...
INSERT INTO test_enum
VALUES(NULL);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="set类型" tabindex="-1"><a class="header-anchor" href="#set类型" aria-hidden="true">#</a> SET类型</h2>
...
SELECT *
FROM test_set;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二进制字符串类型" tabindex="-1"><a class="header-anchor" href="#二进制字符串类型" aria-hidden="true">#</a> 二进制字符串类型</h2>
...
<h4 id="blob类型" tabindex="-1"><a class="header-anchor" href="#blob类型" aria-hidden="true">#</a> BLOB类型</h4>
...
<h2 id="json-类型" tabindex="-1"><a class="header-anchor" href="#json-类型" aria-hidden="true">#</a> JSON 类型</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>当需要检索JSON类型的字段中数据的某个具体值时，可以使用“-&gt;”和“-&gt;&gt;”符号。</p>
...
<h2 id="空间类型" tabindex="-1"><a class="header-anchor" href="#空间类型" aria-hidden="true">#</a> 空间类型</h2>
...
<p>下面展示几种常见的几何图形元素：</p>
<p><img src="https://s2.loli.net/2022/09/14/9RNELJdOvsU2ctQ.png" alt="image-20211104192912988.png" loading="lazy"></p>
<ul>
...
<p><img src="https://s2.loli.net/2022/09/14/LEwXifqavh3yMUj.png" alt="image-20211104193330204.png" loading="lazy"></p>
<h2 id="小结及选择建议" tabindex="-1"><a class="header-anchor" href="#小结及选择建议" aria-hidden="true">#</a> 小结及选择建议</h2>
